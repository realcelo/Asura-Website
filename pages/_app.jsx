...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/HpYpQ3Bdn2",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1029772012589154427&permissions=277028603904&scope=bot%20applications.commands",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/1029772012589154427/vote",
    },
    {
      link: true,
      name: "Partners",
